...
<?php echo form_open('system-user-add'); ?>
        ...
        <div class="card card-default" style="margin-top:15px">
          <div class="card-header">
            <a href="<?php echo site_url('system-users'); ?>" class="btn btn-success pull-right btn-sm">Back</a> 
             <h1 style="font-weight: bold">System User Add</h1>
          </div>
            <div class="card-body">
                <div class="row">
		<div class="col-md-12">
		<label for="UserActive">User Active
			<input type="checkbox" name="UserActive" value="1" id="UserActive" />
                </label>
                    <br /><br />
		</div>
                <div class="col-md-4"><br />
		<label for="UserFName"><span class="text-danger">*</span>First Name</label>
			<input type="text" name="UserFName" value="<?php echo $this->input->post('UserFName'); ?>" class="form-control" id="UserFName" />
			<span class="text-danger"><?php echo form_error('UserFName');?></span>
		</div>
		<div class="col-md-4"><br />
		<label for="UserMName" >Middle Name</label>
			<input type="text" name="UserMName" value="<?php echo $this->input->post('UserMName'); ?>" class="form-control" id="UserMName" />
		</div>
		<div class="col-md-4"><br />
		<label for="UserLName" ><span class="text-danger">*</span>Last Name</label>
			<input type="text" name="UserLName" value="<?php echo $this->input->post('UserLName'); ?>" class="form-control" id="UserLName" />
			<span class="text-danger"><?php echo form_error('UserLName');?></span>
		</div>
		<div class="col-md-4"><br />
		<label for="UserPhone1" ><span class="text-danger">*</span>Phone</label>
			<input type="text" name="UserPhone1" value="<?php echo $this->input->post('UserPhone1'); ?>" class="form-control" id="UserPhone1" />
			<span class="text-danger"><?php echo form_error('UserPhone1');?></span>
		</div>
		<div class="col-md-4"><br />
		<label for="UserPhone2" >Alt. Phone</label>
			<input type="text" name="UserPhone2" value="<?php echo $this->input->post('UserPhone2'); ?>" class="form-control" id="UserPhone2" />
		...
		<label for="UserFullAddress" ><span class="text-danger">*</span>Address</label>
			<textarea name="UserFullAddress" class="form-control" id="UserFullAddress"><?php echo $this->input->post('UserFullAddress'); ?></textarea>
