<?php echo form_open('user_role/add',array("class"=>"form-horizontal")); ?>
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="URoleTitle" value="<?php echo $this->input->post('URoleTitle'); ?>" class="form-control" id="URoleTitle" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="URoleGroup" value="<?php echo $this->input->post('URoleGroup'); ?>" class="form-control" id="URoleGroup" />
		</div>
	</div>
	<div class="form-group">
		<label for="URoleParent" class="col-md-4 control-label">URoleParent</label>
		<div class="col-md-8">
			<input type="text" name="URoleParent" value="<?php echo $this->input->post('URoleParent'); ?>" class="form-control" id="URoleParent" />
		</div>
	</div>
