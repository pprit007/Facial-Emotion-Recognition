...
<body>
  ...
  <div class="card">
      ...
      <div class="card-footer">
          ...
          <a href="<?php echo site_url('registration'); ?>">Do Not Have Account ! Click here to Sign Up</a>
      </div>
      </div>
  </div>
             <?php echo form_close(); ?>
  ...
  <div class="card">
      ...
      <center><?php if(isset($errorf)){ echo $errorf;} ?></center>
      </div>
      <div class="card-body">
          <div class="input-group mb-3">
          <input type="text" class="form-control" name="user_loginn" placeholder="Username" value="<?php echo $this->input->post('user_loginn');?>">
          <div class="input-group-append input-group-text">
              <span class="fas fa-envelope" <?php echo (form_error('user_loginn'))?'style="color:red"':'';?>></span>
          </div>
        </div>
      </div> 
      <div class="card-footer">
          <button type="submit" class="btn btn-success">Forgot</button><br><br>
          <a href="<?php echo site_url('resend-verification'); ?>">Resend Verfication </a>
      </div>
      </div>
  </div>
 <?php echo form_close(); ?>
