    ...
    <div id="wrapper" class="wrapper">
        ...
        <section class="padding-top-6 padding-bottom-7 bg--accent">
            <div class="container">
                <div class="row">
                    <div class="col-lg-8">
                        <?php echo form_open('forgot-password',array('class'=>'listing-form')); ?>
                            <div class="inner-box">
                                <h3 class="inner-item-heading2">Forgot Password</h3>
                                
                                <span class="text-danger"><?php if(isset($errorf)){ echo $errorf;} ?><br /><br /></span>
                                <div class="row">
                                    <div class="col-12">
                            ...
                            <div class="inner-box">
                                <button type="submit" class="btn-upload">forgot Password</button>
                            </div>
                        <div class="col-12" style="text-align:center">
                            <label class="control-label" style="font-weight: 10">NOTE : Check your email inbox or spam folder. </span></label>
                        </div>
                        <div class="col-12">
                            <a href="<?php echo site_url('login'); ?>" style="text-align: left;text-decoration: underline">Already Account</a>
